...
<div class="head-desc">
	<div id="test-aniomation" class="container-desc">
...
<section class="realisation">
	<?php if (have_rows('realisation_section')) : ?>
		<?php while (have_rows('realisation_section')) : the_row();
			$img_realisation = get_sub_field('img_realisation');
			$realisation_desc = get_sub_field('realisation_desc');
		?>
			<div class="content-realisation">
				<div class="img-realisation" style="background-image: url('<?php echo $img_realisation['url'] ?>');"></div>
				<div class="realisation-desc"> <?php echo $realisation_desc ?></div>
			</div>
		    <?php endwhile; ?>
    <?php endif; ?>
</section>
<div class="description-last">
	<div class="description_desc">
		<?php echo get_field('description_home_2'); ?>
	</div>
</div>
